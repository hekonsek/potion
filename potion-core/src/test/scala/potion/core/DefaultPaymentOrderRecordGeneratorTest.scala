...
class DefaultPaymentOrderRecordGeneratorTest extends FunSuite {
  ...
  test("Should generate example from ING specification.") {
    ...
    val ingReferenceDate = paymentOrderDateFormat.parse("20040510")
    val paymentOrder = PaymentOrder(
      transactionType = 110, dateOfPayment = ingReferenceDate, amount = 403595, senderBankSettlementNumber = 10501038,
      senderBankAccountNumber = "29105010381000002201994791", receiverBankAccountNumber = "40109018700000000100198454",
      ...
      descriptionOfPayment = Seq("OPIS_PLATNOSCI_1", "OPIS_PLATNOSCI_2", "", ""), clientCorrelationId = Some("CLIENTID")
    )
